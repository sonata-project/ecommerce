...
//        }
    ...
    public function copyVariation(ProductInterface $product, $name = 'all', $force_copy = false)
    {
    ...
    public function copyProductVariation(ProductInterface $product, $force_copy = false)
    {
     ...
     */
    public function getAddBasketForm(ProductInterface $product, $validator, $options = array())
    {
     ...
     */
    public function basketAddProduct(BasketInterface $basket, ProductInterface $product, $values)
    {
     ...
     * @return BasketElement
     */
    public function basketMergeProduct(BasketInterface $basket, ProductInterface $product, $values)
    {
     ...
     * @return boolean
     */
    public function isAddableToBasket(BasketInterface $basket, ProductInterface $product, $options = array())
    {
