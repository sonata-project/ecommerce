...
namespace Sonata\CustomerBundle\Controller\Api\Legacy;
...
class CustomerController
{
     ...
     * @Rest\QueryParam(name="count", requirements="\d+", default="10", description="Number of customers per page")
    ...
    protected function getCustomer($id)
    {
        ...
        if (null === $customer) {
            throw new NotFoundHttpException(sprintf('Customer not found for identifier %s.', var_export($id, true)));
        }
