...
class AddressController
{
     ...
     * @Rest\QueryParam(name="count", requirements="\d+", default="10", description="Number of addresses per page")
    ...
    protected function getAddress($id)
    {
        ...
        if (null === $address) {
            throw new NotFoundHttpException(sprintf('Address not found for identifier %s.', var_export($id, true)));
        }
