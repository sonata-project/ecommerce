        ...
        $node
            ->children()
                ->arrayNode('class')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('basket')->defaultValue('App\\Sonata\\BasketBundle\\Entity\\Basket')->end()
                        ->scalarNode('basket_element')->defaultValue('App\\Sonata\\BasketBundle\\Entity\\BasketElement')->end()
