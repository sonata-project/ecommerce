...
namespace Sonata\OrderBundle\Controller\Api\Legacy;
...
class OrderController
{
     ...
     * @Rest\QueryParam(name="count", requirements="\d+", default="10", description="Number of orders per page")
    ...
    protected function getOrder($id)
    {
        ...
        if (null === $order) {
            throw new NotFoundHttpException(sprintf('Order not found for identifier %s.', var_export($id, true)));
        }
