        ...
        $node
            ->children()
                ->arrayNode('class')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('invoice')->defaultValue('App\\Sonata\\InvoiceBundle\\Entity\\Invoice')->end()
                        ->scalarNode('invoice_element')->defaultValue('App\\Sonata\\InvoiceBundle\\Entity\\InvoiceElement')->end()
