...
namespace Sonata\InvoiceBundle\Controller\Api\Legacy;
...
class InvoiceController
{
     ...
     * @Rest\QueryParam(name="count", requirements="\d+", default="10", description="Number of invoices per page")
    ...
    protected function getInvoice($id)
    {
        ...
        if (null === $invoice) {
            throw new NotFoundHttpException(sprintf('Invoice not found for identifier', var_export($id, true)));
        }
